...
class DashExample {
  static String backToTwentyEp1 = 'https://m.cdn.miniseri.co.id/back_to_twenty_ep1/dash/manifest.mpd';
  static String backToTwentyEp2 = 'https://m.cdn.miniseri.co.id/back_to_twenty_ep2/dash/manifest.mpd';
  static String backToTwentyEp3 = 'https://m.cdn.miniseri.co.id/back_to_twenty_ep3/dash/manifest.mpd';
  static String backToTwentyEp4 = 'https://m.cdn.miniseri.co.id/back_to_twenty_ep4/dash/manifest.mpd';
  static String backToTwentyEp5 = 'https://m.cdn.miniseri.co.id/back_to_twenty_ep5/dash/manifest.mpd';
  static String backToTwentyEp6 = 'https://m.cdn.miniseri.co.id/back_to_twenty_ep6/dash/manifest.mpd';
  static String backToTwentyEp7 = 'https://m.cdn.miniseri.co.id/back_to_twenty_ep7/dash/manifest.mpd';
  static String backToTwentyEp8 = 'https://m.cdn.miniseri.co.id/back_to_twenty_ep8/dash/manifest.mpd';
}
